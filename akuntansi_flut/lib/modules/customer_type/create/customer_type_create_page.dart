...
import 'customer_type_create.dart';

class CustomerTypeCreatePage extends StatelessWidget {
  const CustomerTypeCreatePage({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: GetBuilder<CustomerTypeCreateController>(
