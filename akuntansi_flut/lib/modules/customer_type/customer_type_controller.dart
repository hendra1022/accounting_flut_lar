...
class CustomerTypeController extends BaseController {
  CustomerTypeDataTableSource dataSource = CustomerTypeDataTableSource();
  ...
  void sortData<T>(Comparable<T> Function(CustomerType customerType) getField, int colIndex, bool ascending) {
