                  ...
                  builder: (controller) => ConstrainedBox(
                    ...
                    child: Visibility(
                      ...
                      child: DataTable(
                        ...
                        columns: [
                          tableColumn(controller, "Code", (user) => user.code!, minWidth: Get.width * (30 / 100)),
                          tableColumn(controller, "Name", (user) => user.name!, minWidth: Get.width * (30 / 100)),
                          tableColumn(controller, "Active", (user) => user.active!, minWidth: Get.width * (10 / 100)),
